    ...
    <div className='w-full py-[10rem] px-4 bg-white' id='nicho'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <button className='bg-[#44ee77] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Saiba mais</button>
          </div>
          <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
              <img className='w-20 mx-auto mt-[-3rem] bg-transparent' src={Triple} alt="/" />
              <h2 className='text-2xl font-bold text-center py-8'>Estabelecimentos</h2>
              <p className='text-center text-4xl font-bold'></p>
              <div className='text-center font-medium'>
              ...
              <button className='bg-black text-[#44ee77] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Saiba mais</button>
          </div>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
