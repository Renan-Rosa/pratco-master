  ...
  return (
    ...
    >
      <div>
        ...
        <p className="py-4">
          Valorizamos a sua confiança em nós como seu fornecedor de confiança
          para uma alimentação saudável e gostosa. Descubra o prazer de comer
          bem com os produtos da nossa empresa
        </p>
